  ...
  if (subMenuItems) {
    return (
      ...
      >
        ...
        {isMenuOpen && (<PlaylistContextMenu
            menuItems={subMenuItems}
            classes={`bg-[#282828] text-[#eaeaea] text-sm p-1 rounded shadow-xl cursor-default absolute top-0 ${menuPositionYClass} ${menuPositionXClass}`}
          />
        )}
      </li>
    );
